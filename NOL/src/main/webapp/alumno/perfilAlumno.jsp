        ...
        <div class="perfil-card border">
            <div class="card-body">
                <section class="datos-foto-container">
                    <div class="avatar-container mx-auto mb-3" style="text-align:center;">
                        <i class="fas fa-user-graduate avatar-icon" style="font-size: 64px;"></i>
                    </div>
                    ...
                    <div class="photo-container">
                        <img src="" alt="Foto del alumno" id="fotoAlumno" class="foto-alumno" />
                    </div>
                </section>
